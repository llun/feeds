                  ...
                  var be,
                    we = {
                      ...
                      stream_ops: {
                        ...
                        write: function (e, t, r, n, o, i) {
                          ...
                          return (
                            (s.usedBytes = Math.max(s.usedBytes, o + n)),
                            n
                          )
                        },
                        ...
                        msync: function (e, t, r, n, o) {
                          if (!Ee.isFile(e.node.mode))
                            throw new Ee.ErrnoError(43)
                          return (
                            2 & o || we.stream_ops.write(e, t, 0, n, r, !1),
                            0
                          )
                        }
                      }
                    ...
                    Ee = {
                      ...
                      hashAddNode: function (e) {
                        ...
                        ;((e.name_next = Ee.nameTable[t]),
                          (Ee.nameTable[t] = e))
                      },
                      hashRemoveNode: function (e) {
                        var t = Ee.hashName(e.parent.id, e.name)
                        if (Ee.nameTable[t] === e) Ee.nameTable[t] = e.name_next
                        else
                      ...
                      mayOpen: function (e, t) {
                        return e
                          ? Ee.isLink(e.mode)
                            ? 32
                            : Ee.isDir(e.mode) &&
                                ('r' !== Ee.flagsToPermissionString(t) ||
                                  512 & t)
                              ? 31
                              : Ee.nodePermissions(
                                  e,
                      ...
                      open: function (e, t, r, n, o) {
                        ...
                        if (
                          ...
                          e = _e.normalize(e)
                          try {
                            s = Ee.lookupPath(e, { follow: !(131072 & t) }).node
                          } catch (e) {}
                        }
                        var a = !1
                        if (64 & t)
